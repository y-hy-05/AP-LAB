    ...
    return (
        <section className="relative bg-[#121212] py-16 sm:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto">
                ...
                {/* Quote Section */}
                <div className="group bg-[#1E1E1E] rounded-2xl p-8 sm:p-10 mb-16 border border-[#2A2A2A] hover:border-[#DFA53B] transition-all duration-500">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <span className="text-[#DFA53B] font-semibold text-lg">AP</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    {/* Card 1 */}
                    <div className="group bg-[#1E1E1E] p-6 sm:p-8 rounded-xl border border-[#2A2A2A] hover:border-[#DFA53B] transition-all duration-500">
